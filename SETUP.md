...
The easiest first test is to deploy them with the Supabase CLI. From the repository root:
    ...
    supabase functions deploy consent --no-verify-jwt
...
In Supabase, set these Edge Function secrets:
    ...
    APP_BASE_URL=https://YOUR_GITHUB_USERNAME.github.io/YOUR_REPOSITORY_NAME
    EMAIL_FROM=Video Message Test <your-sender@example.com>
